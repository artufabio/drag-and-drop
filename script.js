...
// Update item - Delete if necessery, or update Array value
...
function rebuildArrays() {
  backlogListArray = Array.from(backlogList.children).map( item => item.textContent);     // Array.from(backlogList.children) =>returns an array
